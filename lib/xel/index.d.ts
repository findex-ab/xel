...
export type XFunction<CustomPropsType extends XUserProps = XUserProps, StateType extends XAnyObject = XAnyObject> = (config: XElementConfig<CustomPropsType, StateType> & CustomPropsType, state: StateType, callee: XCallee<CustomPropsType, StateType>) => XNativeRenderableFactor | XRenderable;
...
export declare const xUpdate: (x: XElement, callee?: XCallee) => XNativeRenderableFactor;
